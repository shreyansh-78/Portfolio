          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/shreyansh-78/Ecommerce-Website" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>A Working Ecommerce Website</h3>
              <p> Developed a Ecommerce Website using React, Axios, Express, and Cors, enabling users to shop, cast votes, and access details through an interactive UI, leveraging serverless architecture for scalability and cost-efficiency. </p>
            </div>
            <footer> <ul className="tech-list"> <li>React</li> <li>Axios</li> <li>Express</li> </ul> </footer>
          </div>
        </ScrollAnimation>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><title>Folder</title> <path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path> </svg>
              <div className="project-links">
                <a href="https://github.com/shreyansh-78/Tinder-Clone" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" /> </a>
                <a href="https://github.com/shreyansh-78/Tinder-Clone" target="_blank" rel="noreferrer">
            ...
            <div className="body">
              <h3>Tinder like platform</h3>
              <p>
                Developed an interactive chatbot application using React, Tinder Card, and Mongodb for storing users in backend, enabling users to interact with each other by right & left swiping.
              </p>
            </div>
            <footer>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/shreyansh-78/IMDB-Clone" target="\_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://imdb-clone-sage-eight.vercel.app/" target="\_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>IMDB Clone</h3>
              <p>
                Developed An IMDb-inspired web application built with React, Redux, and Vite, providing users with a comprehensive platform to discover, explore, and rate movies.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/shreyansh-78/Decentralized-Swap" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://github.com/shreyansh-78/Decentralized-Swap" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>Decentralized-Swap</h3>
              <p>Developed a Decentralized Swap platform facilitating ERC20 token transactions, integrating a Solidity smart contract for token operations and a user-friendly frontend connected to MetaMask for seamless interaction.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              ...
              <div className="project-links">
                <a href="https://github.com/shreyansh-78/2048game" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://github.com/shreyansh-78/2048game" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>2048 Game</h3>
              <p>"Created a captivating 2048 game using JavaScript, HTML, and CSS, offering players an engaging puzzle experience with intuitive controls and sleek design.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
              <a href="https://github.com/shreyansh-78/Netflix" target="_blank" rel="noreferrer">
                  <img src={githubIcon} alt="Visit site" />
                </a>
                <a href="https://github.com/shreyansh-78/Netflix" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
            ...
            <div className="body">
              <h3>Netflix Clone</h3>
              <p>
              Created a Netflix-inspired clone using React.js, leveraging the TMDB API for movie data and the 'movie-trailer' package for dynamic trailer playback, resulting in a captivating user experience reminiscent of the original platform.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
